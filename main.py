...
auth = tweepy.OAuthHandler('KJnKoRpbIuFf7QxnhWDEzge7b', 'm08vZoaAvOcMp8I2YFhpPcCzrx5wIq6R4tk8gZmibqM7Gn7BgA')
...
# Swapped api.user_timeline into tweepy.Cursor. Cursor allows us to use any
# method of the tweepy API (like api.user_timeline and api.search). All things
# we can search is here : https://docs.tweepy.org/en/stable/api.html
...
# by hashtags
public_tweets = tweepy.Cursor(api.search, q='#COVID -filter:retweets -filter:replies', tweet_mode='extended', lang='en').items(100)
...
# To summerize this section, I more or less just got every item in Status object
